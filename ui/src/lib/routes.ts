...
export const routes: RouteItem[] = [
  {
    ...
    section: "OS Kernel",
    summary: "Live system state. Agent fleet. Hardware posture.",
  },
  {
    path: `${APP_PREFIX}/agent-fleet`,
    label: "Agent Fleet",
    section: "OS Kernel",
    summary: "Spawn, monitor, and terminate agents.",
  },
  {
    path: `${APP_PREFIX}/hardware`,
    label: "Hardware",
    section: "OS Kernel",
    summary: "GPU VRAM, utilization, and model fit matrix.",
  },
  {
    path: `${APP_PREFIX}/kernel`,
    label: "Kernel Decisions",
    section: "OS Kernel",
    summary: "Task classification and model selection trace.",
  },
  {
    path: `${APP_PREFIX}/chat`,
    label: "Dispatch",
    section: "Execute",
    summary: "Send a mission to the agent fleet.",
  },
  {
